...
use App\Http\Controllers\EventRegisterController;
     ...
     Route::post('/membership-payment/process', [PaymentController::class, 'processPaymentapp'])->name('api.membershipPayment.process');
     Route::post('/membership-payment/callback', [PaymentController::class, 'paymentCallbackapp'])->name('api.membershipPayment.callback');
