...
use App\Http\Controllers\EventRegisterController;
     ...
     Route::post('/user/membershipPayment/process', [PaymentController::class, 'processPaymentapp'])->name('api.membershipPayment.process');
     Route::post('/user/membershipPayment/process', [PaymentController::class, 'paymentCallbackapp'])->name('api.membershipPayment.callback');
