...
use App\Http\Controllers\EventRegisterController;
     ...
     Route::post('/user/membershipPayment/callback', [PaymentController::class, 'paymentCallbackapp'])->name('membershipPayment.callback');


     Route::post('/checkout', [OrderController::class, 'checkout'])->name('checkoutapp');
     Route::get('/payment/callback', [OrderController::class, 'paymentCallback'])->name('order.payment.callbackspp');
