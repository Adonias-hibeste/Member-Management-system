        ...
        <div class="card mt-4">
            <div class="card-header">
                <h4 class="d-flex justify-content-between align-items-center">
                    Member Profile
                    <a href="{{route('user.createprofile')}}" class="btn btn-primary btn-sm">Add User</a>
                </h4>
            </div>
            <div class="card-body">
                @if (session('message'))
                    ...
                    <tbody>
                        @foreach($profiles as $item)
                            <tr>
                                ...
                                <td>
                                <a href="{{ url('user/deleteprofile/'.$item->id) }}" class="btn btn-primary" style="background-color: red; color: white; border-color: red;">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
