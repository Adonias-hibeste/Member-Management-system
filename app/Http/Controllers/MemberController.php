    ...
    public function Registerapp(Request $request)
{
    ...
    {$user_id = session('user_id');
        ...
        Log::info('User ID  ' . $user_id); // Log the user ID
        ...
        $profile = Profile::where('id', $user_id)->first(); // Fetch the profile details using id

        if ($profile) {
            Log::info('Profile found for user ID: ' . $user_id); // Log if profile is found
            ...
            Log::info('Profile not found for user ID: ' . $user_id); // Log if profile not found
